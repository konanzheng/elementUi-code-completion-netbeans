 ...
 *
 */
public class VueCompletionItem implements CompletionItem {

    private static final Color FIELD_COLOR = Color.decode("0x0000B2");
    private static final ImageIcon FIELD_ICON = new ImageIcon(ImageUtilities.loadImage("org/netbeans/modules/vuecodecompletion/ele.png"));
    private static final String INFO = "ElementUI";
     ...
     */
    public VueCompletionItem(String tag,String text, int dotOffset, int caretOffset) {
        this.text = text;
        this.tag = tag;
    ...
    /**
     * Returns String containing vue attribute
     *
     * @return attribute
     */
...
//                }
    ...
    public int getPreferredWidth(Graphics graphics, Font font) {
        return CompletionUtilities.getPreferredWidth(text+"...ElementUI", INFO, graphics, font);
    }
    ...
    public CompletionTask createDocumentationTask() {
        return new AsyncCompletionTask(new AsyncCompletionQuery() {
            ...
            protected void query(CompletionResultSet completionResultSet, Document document, int i) {
                completionResultSet.setDocumentation(new VueCompletionDocumentation(VueCompletionItem.this));
